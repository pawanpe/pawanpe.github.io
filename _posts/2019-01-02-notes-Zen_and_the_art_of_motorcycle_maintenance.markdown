...
2. The fabric of society, human work, human intelligence works on this hierarchy, which is unfortunately -- disgusting sometimes.

## CHAPTER 9:
1. I talked about hierarchies of thought - the system. Now I want to talk about methods of finding one's way through these hierarchies - logic.
2. Two kinds o flogic are uses, inductive and deductive. Inductive starts with obsesrvations of the machine and arrive at general conclusions. Deductive start with general knowledge and predict a specific observation.
3. Solution of problems too complicated for common sense  to solve is achieved by long strings of mixed inductive and deductive inferences that weave back and forth between. The correct program for this interweaving is formalized as scientific method.  When you have hit a really tough one, tried everything, racked your brain and nothing works, then Nature has really decided to be difficult, You say, "Ok Nature that's the end of the nice guy" and crank up the formal scientific method.
4. For this you keep a lab notebok. Everything gets written down formally , so that you know at all times where you are in problem solving. In scientific work and electronics, this is necessary becoz otherwize the problwms get so comples that you get lost in them and confused and forget what you kknow and what you don;t know and have to give up.
5. The logical statements entered into the notebook are broken down into 5 (or six) cats: 
    a) Statement of problem
    b) hypothesis as to cause of the problem. -- The results of this will create more hypothesis. This frustrates, but when do we stop and make the conclusion???
